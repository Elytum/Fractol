...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/01/29 14:37:33 by achazal           #+#    #+#             */
/*   Updated: 2015/01/29 14:37:34 by achazal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_inputs_mouse(int button, t_env *e)
{
	...
	{
		e->center.imag += (e->mouse.imag - WIN_WIDTH / 2) / 5 * e->steps.imag;
		e->center.real += (e->mouse.real - WIN_HEIGHT / 2) / 5 * e->steps.real;
		if (button == 4)
		{
			e->steps.real *= 9 / 10.0;
			e->steps.imag *= 9 / 10.0;
